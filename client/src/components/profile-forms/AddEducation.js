...
const AddEducation = ({ addEducation }) => {
  ...
  return (
    <Fragment>
      ...
      <p class="lead">
        <i class="fas fa-code-branch"></i> Add any school or bootcamp that your have attended
      </p>
      ...
      <form class="form" onSubmit={e => {
        ...
        <div class="form-group">
          <textarea
            ...
            value={description} onChange={e => onChange(e)} disabled={toDateDisabled ? 'disabled': ''}
          ></textarea>
        </div>
